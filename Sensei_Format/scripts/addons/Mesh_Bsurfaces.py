...
bl_info = {
    ...
    "description": "Modeling and retopology tool. (Edited For Sensei Format)",
...
class VIEW3D_PT_tools_SURFSK_mesh(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        col.prop(scn, "bSurfSimpleMesh")
        col.prop(scn, "bSurfSmoothShading")
        col.separator()
        col.separator()
...
class GPENCIL_OT_SURFSK_add_surface(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        #SENSEI FORMAT: Smooth Shading 
        #Fix normals
        bpy.ops.mesh.select_all(action='SELECT')
        bpy.ops.mesh.normals_make_consistent()
        bpy.ops.mesh.select_all(action='DESELECT')
        if context.scene.bSurfSmoothShading:
    ...
    def invoke(self, context, event):
        ...
        #SENSEI FORMAT EDIT: Simple Mesh Mode
        if bpy.context.scene.bSurfSimpleMesh:
            EU = 1
            EV = 1
        else:
            EU = 6
...
#SENSEI FORMAT: Smooth shading updater
def bSurfSmoothShading(self,context):
    ob = bpy.context.active_object
    
    bpy.ops.object.mode_set(mode='OBJECT')    
    if self.bSurfSmoothShading:        
        bpy.ops.object.shade_smooth()
    else:
...
def register():
    ...
    try:
        ...
        #SENSEI FORMAT EDIT: Smooth and simple mesh choices
        bpy.types.Scene.bSurfSimpleMesh = bpy.props.BoolProperty(
            name="Simple Mesh Mode",
            default = False)
        
        bpy.types.Scene.bSurfSmoothShading = bpy.props.BoolProperty(
            name="Smooth Shading",
            update = bSurfSmoothShading,
            default = True)
